  ...
  try {
    ...
    if (employeeCount === 0 || employeeCount <= 3) {
      ...
      await Employee.bulkCreate([
        ...
        { id: "EMP-001", clientId: "client-001", name: "Sarah Jenkins", email: "sarah.jenkins@apexglobal.io", designation: "VP of Sales Operations", roleId: "role-admin", baseSalary: 95000, passwordHash: defaultPasswordHash, avatar: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=100&auto=format&fit=crop&q=80" },
        { id: "EMP-002", clientId: "client-001", name: "Marcus Vance", email: "marcus.vance@sales.apex.io", designation: "Enterprise Sales Director", roleId: "role-mgr", baseSalary: 75000, passwordHash: defaultPasswordHash, avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&auto=format&fit=crop&q=80" },
        { id: "EMP-003", clientId: "client-001", name: "Alex Rivera", email: "alex.rivera@sales.apex.io", designation: "Senior Account Executive", roleId: "role-exec", baseSalary: 55000, passwordHash: defaultPasswordHash, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&auto=format&fit=crop&q=80" },
        { id: "EMP-008", clientId: "client-001", name: "Elena Rostova", email: "elena.rostova@hr.apex.io", designation: "Head of Human Resources", roleId: "role-hr", baseSalary: 68000, passwordHash: defaultPasswordHash, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&auto=format&fit=crop&q=80" },
        { id: "EMP-009", clientId: "client-001", name: "Vikram Patel", email: "vikram.patel@ops.apex.io", designation: "Director of Operations & Support", roleId: "role-ops", baseSalary: 72000, passwordHash: defaultPasswordHash, avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&auto=format&fit=crop&q=80" },
        { id: "EMP-010", clientId: "client-001", name: "Dr. Aris Thorne", email: "a.thorne@biogenetics.org", designation: "CTO, BioGenetics Lab Solutions", roleId: "role-customer", baseSalary: 85000, passwordHash: defaultPasswordHash, avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&auto=format&fit=crop&q=80" },

        // Tenant 2 (Nexus Electronics)
        { id: "EMP-004", clientId: "client-002", name: "David Sterling", email: "nexus.admin@nexuselec.com", designation: "Regional Ops Lead", roleId: "role-admin", baseSalary: 80000, passwordHash: defaultPasswordHash, avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&auto=format&fit=crop&q=80" },
        { id: "EMP-005", clientId: "client-002", name: "Jessica Wu", email: "retail.mgr@nexuselec.com", designation: "Retail Sales Lead", roleId: "role-mgr", baseSalary: 62000, passwordHash: defaultPasswordHash, avatar: "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=100&auto=format&fit=crop&q=80" },
