  ...
  try {
    ...
    if (employeeCount === 0 || employeeCount <= 3) {
      ...
      await Employee.bulkCreate([
        ...
        { id: "EMP-008", clientId: "client-001", name: "Elena Rostova", email: "elena.rostova@hr.apex.io", designation: "Head of Human Resources", roleId: "role-hr", passwordHash: defaultPasswordHash, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&auto=format&fit=crop&q=80" },
        { id: "EMP-009", clientId: "client-001", name: "Vikram Patel", email: "vikram.patel@ops.apex.io", designation: "Director of Operations & Support", roleId: "role-ops", passwordHash: defaultPasswordHash, avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&auto=format&fit=crop&q=80" },
        { id: "EMP-010", clientId: "client-001", name: "Dr. Aris Thorne", email: "a.thorne@biogenetics.org", designation: "CTO, BioGenetics Lab Solutions", roleId: "role-customer", passwordHash: defaultPasswordHash, avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&auto=format&fit=crop&q=80" },
